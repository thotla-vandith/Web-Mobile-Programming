...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InfoTxt = (TextView) findViewById(R.id.txt_user);
        ...
        mFirebaseInstance.getReference("app_title").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                Log.e(ACTIVITY_TAG, "App title updated");
            ...
            public void onCancelled(DatabaseError error) {
                ...
                Log.e(ACTIVITY_TAG, "Failed to read app title value.", error.toException());
            }
        });
    ...
    private void addUserChangeListener() {
        ...
        mFirebaseDatabase.child(userId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                // Check for null
                if (user == null) {
                    Log.e(ACTIVITY_TAG, "User data is null!");
                    return;
                }
                Log.e(ACTIVITY_TAG, "User data is changed!" + user.name + ", " + user.phone);

                // Display newly updated name and phone
                InfoTxt.setText(user.name + ", " + user.phone);
            ...
            public void onCancelled(DatabaseError error) {
                // Failed to read value
                Log.e(ACTIVITY_TAG, "Failed to read user", error.toException());
            }
        });
    }
    ...
    private void LogOut(View v){ // Logout function added
        ...
        // Once logging out, it gets back to the homepage
        startActivity(intent);
        finish();
    }
}